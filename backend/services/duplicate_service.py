...
class DuplicateService:
        ...
        try:
            ...
            if os.path.exists(self.storage_file):
                ...
                try:
                    ...
                    logger.error(f"[DuplicateService] Error loading storage: {e}")
        except Exception as e:
            allow_degraded = os.environ.get("ALLOW_DEGRADED_STARTUP", "0") == "1"
            self._load_failed = True
            logger.error(f"[DuplicateService] Failed to load model: {e}")
            if allow_degraded:
    ...
    def save_to_disk(self, ticket_id: str, text: str):
        ...
        try:
            ...
            logger.error(f"[DuplicateService] Failed to save to disk: {e}")
