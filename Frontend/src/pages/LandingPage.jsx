...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-slate-950 font-sans text-slate-800 dark:text-slate-200 transition-colors duration-200">
            {showDemo && <DemoModal onClose={() => setShowDemo(false)} />}

            {/* ==================== NAV ==================== */}
            <nav className="sticky top-0 z-50 bg-white/90 dark:bg-slate-950/90 backdrop-blur-md border-b border-gray-100 dark:border-slate-900 shadow-sm transition-colors duration-200">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        {/* Logo */}
                        <div className="flex items-center gap-2 cursor-pointer" onClick={() => navigate('/')}>
                            <img src="/favicon.png" alt="H" className="w-8 h-8 object-contain" />
                            <span className="font-black text-2xl tracking-tighter text-emerald-900 dark:text-emerald-400 italic uppercase">HelpDesk.ai</span>
                        </div>

                        {/* Desktop Links */}
                        <div className="hidden md:flex items-center gap-8">
                            <a href="#features" className="text-sm font-semibold text-gray-600 dark:text-slate-400 hover:text-emerald-800 dark:hover:text-emerald-400 transition-colors">Features</a>
                            <a href="#how-it-works" className="text-sm font-semibold text-gray-600 dark:text-slate-400 hover:text-emerald-800 dark:hover:text-emerald-400 transition-colors">How It Works</a>
                            <a href="#pricing" className="text-sm font-semibold text-gray-600 dark:text-slate-400 hover:text-emerald-800 dark:hover:text-emerald-400 transition-colors">Pricing</a>
                        </div>
                        ...
                        <div className="hidden md:flex items-center gap-3">
                            ...
                            <button
                                ...
                                className="text-sm font-semibold text-emerald-800 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-900 px-4 py-2 rounded-lg hover:bg-emerald-50 dark:hover:bg-emerald-950/20 transition-all flex items-center gap-1.5"
                            >
                                <Play className="w-3.5 h-3.5 fill-emerald-700 dark:fill-emerald-400" /> Watch Demo
                            </button>
                            <button
                                onClick={() => navigate('/admin-signup')}
                                className="bg-emerald-900 hover:bg-emerald-800 dark:bg-emerald-800 dark:hover:bg-emerald-700 text-white px-5 py-2.5 rounded-lg text-sm font-semibold transition-all shadow-lg shadow-emerald-900/20"
                            >
                                Get Started Free
                            </button>
                        </div>
                        ...
                        <div className="md:hidden">
                            <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="text-gray-600 dark:text-slate-400 hover:text-emerald-800 p-2">
                ...
                {/* Mobile Menu */}
                {isMenuOpen && (
                    <div className="md:hidden bg-white dark:bg-slate-900 border-t border-gray-100 dark:border-slate-800 absolute w-full shadow-xl z-50 transition-colors duration-200">
                        <div className="px-5 pt-3 pb-6 space-y-4">
                            <a href="#features" onClick={() => setIsMenuOpen(false)} className="block text-base font-semibold text-gray-700 dark:text-slate-300 hover:text-emerald-800 dark:hover:text-emerald-400 py-2">Features</a>
                            <a href="#how-it-works" onClick={() => setIsMenuOpen(false)} className="block text-base font-semibold text-gray-700 dark:text-slate-300 hover:text-emerald-800 dark:hover:text-emerald-400 py-2">How It Works</a>
                            <a href="#pricing" onClick={() => setIsMenuOpen(false)} className="block text-base font-semibold text-gray-700 dark:text-slate-300 hover:text-emerald-800 dark:hover:text-emerald-400 py-2">Pricing</a>
                            <div className="pt-4 flex flex-col gap-3 border-t border-gray-100 dark:border-slate-800">
                                <div className="flex justify-between items-center py-1">
                                    <span className="text-sm font-semibold text-gray-500 dark:text-slate-400">Theme</span>
                                    <ThemeToggle />
                                </div>
                                <button onClick={() => { setIsMenuOpen(false); setShowDemo(true); }} className="w-full text-center py-2.5 text-emerald-800 dark:text-emerald-400 font-semibold border border-emerald-200 dark:border-emerald-900 rounded-lg flex items-center justify-center gap-2 hover:bg-emerald-50 dark:hover:bg-emerald-950/20">
                                    <Play className="w-4 h-4 fill-emerald-700 dark:fill-emerald-400" /> Watch Demo
                                </button>
                                <button onClick={() => navigate('/login')} className="w-full text-center py-2.5 text-gray-700 dark:text-slate-300 font-semibold border border-gray-100 dark:border-slate-800 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-800">
                                    Sign In
                                </button>
