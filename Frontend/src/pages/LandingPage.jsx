            ...
            <section className="bg-emerald-950 py-16 md:py-32 text-white relative overflow-hidden" id="how-it-works">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 lg:items-center">
                        ...
                        <div className="w-full lg:w-1/2 h-[350px] lg:h-[500px] relative">
                            <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/10 to-transparent rounded-[32px] lg:rounded-[40px] border border-white/5 backdrop-blur-3xl overflow-hidden p-6 lg:p-12 flex items-center justify-center">
